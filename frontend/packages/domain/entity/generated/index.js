...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/tknr/Development/dapps-boilerplate/frontend/packages/domain/entity/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "frontend/packages/domain/entity/generated",
    "packages/domain/entity/generated",
  ]
...
path.join(process.cwd(), "frontend/packages/domain/entity/generated/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "frontend/packages/domain/entity/generated/schema.prisma")
