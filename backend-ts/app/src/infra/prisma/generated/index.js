...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/service/app/src/infra/prisma/generated",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "sourceFilePath": "/service/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null
...
path.join(process.cwd(), "src/infra/prisma/generated/libquery_engine-linux-arm64-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
