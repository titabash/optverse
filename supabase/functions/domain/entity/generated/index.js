...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "../supabase/functions/domain/entity/generated",
    "supabase/functions/domain/entity/generated",
  ]
...
path.join(process.cwd(), "../supabase/functions/domain/entity/generated/libquery_engine-darwin-arm64.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "../supabase/functions/domain/entity/generated/schema.prisma")
